...
adminHandler.index = function (req, res) {
    if (!req.session.user) {
...
adminHandler.content = function (req, res) {
    res.render('backstage/content');
}

adminHandler.login = function (req, res) {
    res.render('backstage/login',{error:null});
}

adminHandler.doLogin = function (req, res) {
...
adminHandler.myInfo = function (req, res) {
...
adminHandler.adminList = function (req, res) {
...
adminHandler.adminEdit = function (req, res) {
...
adminHandler.doAdminUpdate = function (req, res) {
...
adminHandler.articlesEdit = function (req, res) {
...
adminHandler.doArticleDelete = function (req, res) {
...
adminHandler.doArticleEdit = function (req, res) {
...
adminHandler.updateArticlesEdit = function (req, res) {
    // var query = 'insert into article(article_title) values(article_title)';
    res.redirect('/admin/articlesEdit');
    return;
}

adminHandler.articleAdd = function (req, res) {
    res.render('backstage/articleAdd');
}

adminHandler.doArticleAdd = function (req, res) {
...
adminHandler.tagsEdit = function (req, res) {
...
adminHandler.doTagDelete = function (req, res) {
...
adminHandler.doTagEdit = function (req, res) {
...
adminHandler.updateTagsEdit = function (req, res) {
...
adminHandler.tagAdd = function (req, res) {
    res.render('backstage/tagAdd');
}

adminHandler.doTagAdd = function (req, res) {
    var name = req.body.name;
